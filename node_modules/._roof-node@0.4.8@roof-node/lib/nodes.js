...
//兼容旧版本，只是语法糖
classPrototype.merge = function (collection) {
  var that = this;
...
classPrototype.destroy = function (where) {
  var _this3 = this;
...
}, "update.uncalled", "update.called"];

classActions.remove = [function (where) {
  this.dump(where);
}, "remove.uncalled", "remove.called"];
...
classActions.empty = [function () {
  ...
  return this;
}, "empty.uncalled", "empty.called"];

classActions.fill = [function (nodes) {
  var _this5 = this;
...
classActions.replace = [function (nodes) {
  ...
  return this;
}, "replace.uncalled", "replace.called"];

//不再把 destroy 当做一个 action
//因为 destroy 掉之后要释放内存
//如果当做 action 就没有机会删掉 states 了
...
//
//  return this
//}, 'destroy.uncalled', 'destroy.called']
